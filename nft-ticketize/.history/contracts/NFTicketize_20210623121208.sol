...
contract NFTicketize{ 
  ...
  mapping(uint256 => EventForTicket) eventsForTicket;
  ...
  function getEventsForTicketCounter() public view returns(mapping(uint256 => EventForTicket)) {
      return eventsForTicket;
  }
}