...
function ButtonsBox({onReloadList, onSetOverlay, onSetSnackBarMessage}) {
 ...
 uint256 _resellTicketType, uint32 _resellTicketValue, string memory _metadataIpfsCid) public {
    ...
    try {
      ...
      await nftTicketizeContractWithSigner.createTicketCategory(eventKey, _maxSubscriber, price, resellFeeType, resellFeeValue, cid.string);
