...
function ButtonsBox({onReloadList, onSetOverlay}) {
  ...
  const [categoryNameValidation, setcntNameValidation] = React.useState(false);
  ...
  const handleCreteNewTier = () => {
    ...
    createNewTier(categoryName, cntDesc, cntLimitedUnlimited, cntMaxSubscriber,
    ...
    return (
      <div>
        <div>
          ...
          <Dialog open={open} validate onClose={handleClosecnt} aria-labelledby="form-dialog-title">
