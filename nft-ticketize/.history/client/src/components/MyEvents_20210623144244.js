...
function ButtonsBox({ onReloadList, onSetOverlay}) {
  ...
  const handleCreateNewEvent = () => {
    ...
    const contract = require("../contracts/NFTicketize.json"); // for Hardhat
    const NFTicketizeContract = new window.ethereum.Contract(contract.abi, EnvConstant.contractAddress);
