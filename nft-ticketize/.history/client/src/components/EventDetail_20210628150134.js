...
function ButtonsBox({onReloadList, onSetOverlay, onSetSnackBarMessage}) {
  ...
  const geTicketCategoriesFromEvent = async () => {
    ...
    if (ticketCategories.length > 0) {
      ...
      for (var counter = 0; counter < ticketCategories.length; counter++) {
        ...
        data.push({
          ...
          soldTickets: 0,
          maxTickets: ticketCategories[counter].maxTickets,
          resellTicketType: ticketCategories[counter].resellTicketType,
          resellTicketValue: ticketCategories[counter].resellTicketValue,
          name: ipfsData.name,
    ...
    return (
      <div>
        <div>
          ...
          <Async promiseFn={geTicketCategoriesFromEvent}>
            <Async.Loading>Loading...</Async.Loading>
            <Async.Fulfilled>
              {data => {
              return (
                    ...
                    <Grid item xs>
                          <Card className={classes.root}>
                            <CardContent>
                              ...
                              <Typography variant="body2" component="p" color="textSecondary">
                              #Max tickets {ticketCategory.soldTickets}/{ticketCategory.maxTickets === 0 ? "Unlimited" : ticketCategory.maxTickets}
                              <br />
                              </Typography>
                              <Typography variant="body2" component="p" color="textSecondary">
                              #Resell fee (type) - {ticketCategory.resellTicketType === 1? "Percent" : "Fixed"}
                              <br />
                              </Typography>
                              <Typography variant="body2" component="p" color="textSecondary">
                              #Resell fee (value) - {ticketCategory.resellTicketValue} {ticketCategory.resellTicketType === 1? "%" : " ETH "}
                              <br />
                              </Typography>
                            </CardContent>
                            <CardActions>
