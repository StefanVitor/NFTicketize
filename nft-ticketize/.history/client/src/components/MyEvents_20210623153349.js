...
function ButtonsBox({ onReloadList, onSetOverlay}) {
  ...
  const createEvent = async () => {
    //const NFTicketizeContractArt = artifacts.require("../contracts/NFTicketize.json"); // for Hardhat

    const storageContract = new web3.eth.Contract("../contracts/NFTicketize.json", EnvConstant.contractAddress);
