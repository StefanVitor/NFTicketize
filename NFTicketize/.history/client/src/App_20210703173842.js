...
import {CreateIPFSRef} from "./UtilsData";
    ...
    <div>
      <Router>
            <div>
                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-light">
                    <div className="container-fluid">
                        <ul className="navbar-nav mr-auto">
                            ...
                            <li><Link to={'/my_tickets'} className="nav-link">My tickets</Link></li>
                            <li hidden={!isLoggedIn}><Link to={'/my_events'} className="nav-link">My events</Link></li>
                            <li><Link to={'/ticket_market'} className="nav-link">Ticket market</Link></li>
                        </ul>
                        {isLoggedIn === true ? 
                ...
                <Switch>
                    <Route exact path='/' component={() => <Home ipfs = {ipfs} />} />
                    <Route path='/my_tickets' component={MyTickets} />
                    <Route path='/my_events' component={() => <MyEvents ipfs={ipfs} />} />
                    <Route path='/event_detail' component={() => <EventDetail ipfs = {ipfs} />} />
