...
export async function GetTicketsForBid(_address, _eventId)  {
    ...
    for(var counter = 0; counter < data.length; counter++) {
        data[counter].tokenId = parseInt(events[counter].id;
        const ticket = await axios.get(EnvConstant.raribleServer +`/protocol/v0.1/ethereum/nft/items/` +  EnvConstant.contractAddress + `:` + _continuation);
    }
