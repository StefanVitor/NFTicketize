...
export const ORDER_DATA_V1 = id("V2");
...
export function CreateCancelOrderOld (maker, contract, tokenId, price ) {
    return {
      type: "RARIBLE_V2",
      maker: maker,
      makeAsset: {
        "assetType": {
          ...
          "data": "0x000000000000000000000000cec032b2a2be0a92e28c7d647d0f60b7a62735cd"
        },
        "value": "1",
      },
      takeAsset: {
...
export async function SignOrderMessage (
    ...
    const data = const signature = await SignOrderMessage(
