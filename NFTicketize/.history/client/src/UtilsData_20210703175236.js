...
// Get details about ticket (eventId, eventName, categoryId, categoryName)
export async function GetForBid(_ticketId)  {
    // Get eventId and ticketCategoryId from informations about ticket
    const ticketQuery = `
    ...
    var eventId =ticketDetail.eventId;
    var ticketCategoryId = ticketDetail.ticketCategoryId;
    ...
    var eventDetail = dataFromSubGraph.data.events;
