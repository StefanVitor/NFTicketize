...
export async function GetDetailsAboutTicket(_ticketId)  {
    ...
    var ticketCategoryDetail = ticketCategoryDataFromSubGraph.data.events;
    var metadataIpfsCid = ticketCategoryDetail[0].metadataIpfsCid;
    const ipfsDataTicketCategory = uint8ArrayConcat(await all(ipfs.cat(metadataIpfsCid)));
