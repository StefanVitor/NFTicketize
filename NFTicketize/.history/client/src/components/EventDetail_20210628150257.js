                    ...
                    <Grid item xs>
                          <Card className={classes.root}>
                            <CardContent>
                              ...
                              <Typography variant="body2" component="p" color="textSecondary">
                              #Max tickets {ticketCategory.sold_tickets}/{ticketCategory.max_tickets === 0 ? "Unlimited" : ticketCategory.max_tickets}
                              <br />
                              </Typography>
                              <Typography variant="body2" component="p" color="textSecondary">
                              #Resell fee (type) - {ticketCategory.resell_ticket_type === 1? "Percent" : "Fixed"}
                              <br />
                              </Typography>
                              <Typography variant="body2" component="p" color="textSecondary">
                              #Resell fee (value) - {ticketCategory.resell_ticket_value} {ticketCategory.resell_ticket_type === 1? "%" : " ETH "}
                              <br />
                              </Typography>
                            </CardContent>
                            <CardActions>
