...
function BuyDialog({onReloadList, onSetOverlay, eventKey, buyDialogOpen, setBuyDialogOpen,
  ...
  async function generateTokenId(minter) {
    const res = await client.get(`/protocol/v0.1/ethereum/nft/collections/`+EnvConstant.contractAddress`/generate_token_id?minter=${minter}`)
  ...
  function getAddress(type: "ERC721" | "ERC1155"): string {
    return type === "ERC721" ? "0x0714AE5E9e7d1733B8D3d52eed03116eF71c14eb" : "0x6a94aC200342AC823F909F142a65232E2f052183"
  }
