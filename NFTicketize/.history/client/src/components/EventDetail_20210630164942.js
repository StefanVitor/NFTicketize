...
function TicketCategoryDetail({onReloadList, onSetOverlay}) {  
  ...
  const getTickets = async () => {
    const tokenIdData =  await axios.get(`https://api-dev.rarible.com/protocol/v0.1/ethereum/nft/items/byOwner` + EnvConstant.contractAddress +`/generate_token_id?minter=`+ address + ``);
