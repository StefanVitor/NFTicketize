...
function TicketMarketDetail({onReloadList, onSetOverlay, onSetSnackBarMessage}) {  
...
function TicketMarketInner() {
  ...
  return (
    ...
    >
      <div>
        <TicketMarketDetail onReloadList={reloadListFunc} onSetOverlay={setOverlayFunc} onSetSnackBarMessage = {setSnackBarMessage}>
        </TicketMarketDetail>
      </div>
    </LoadingOverlay>
  );
