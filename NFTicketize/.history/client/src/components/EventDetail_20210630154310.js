...
function TicketCategoryDetail({onReloadList, onSetOverlay}) {  
  ...
  const buyDialogHandleBuy = async() => {
    ...
    try {
      ...
      var _ticketCategoryPrice = parseInt(ticketCategoryPriceForDialog) * totalNumberOfTickets;
      let overrides = {
        // To convert Ether to Wei:
        value: ethers.utils.parseEther(ticketCategoryPriceForDialog)     // ether in this case MUST be a string
