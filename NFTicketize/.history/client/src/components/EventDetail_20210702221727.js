...
function ForBidDialog({onReloadList, onSetOverlay}) {
  return (<Dialog open={buyTicketDialogOpen} onClose={() => buyTicketDialogHandleClose()} aria-labelledby="form-dialog-title">
    <DialogTitle id="form-dialog-title">Buy ticket</DialogTitle>
    <DialogContent>
      <DialogContentText id="alert-dialog-description">
