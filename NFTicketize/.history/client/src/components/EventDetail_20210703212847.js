                                            ...
                                            <Card className={classes.root}>
                                              ...
                                              <CardActions>
                                                  <Box component="div" visibility={bid.accept_bid === true? "visible" : "hidden"}>
                                                    <Button onClick={() => { acceptBidOffer(bid.hash, ticket.order)}} size="small" >Accept bid</Button>
                                                  </Box>
                                                  <Box component="div" visibility={bid.cancel_bid === true? "visible" : "hidden"}>
                                                    <Button onClick={() => { cancelBidOffer(ticket.tokenId)}} size="small" >Cancel bid</Button>
                                                  </Box>
                                                </CardActions>
                                            </Card>
                                        </Grid>
