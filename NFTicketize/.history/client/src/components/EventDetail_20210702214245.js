...
function TicketCategoryDetail({onReloadList, onSetOverlay, ipfs}) {  
  ...
  return (<div>
    ...
    <BuyDialog onReloadList={onReloadList} onSetOverlay={onSetOverlay} eventKey={eventKey} buyDialog={buyDialogOpen}>
...
function BuyDialog({onReloadList, onSetOverlay, eventKey}) {
