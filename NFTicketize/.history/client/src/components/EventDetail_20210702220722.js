              ...
              <Grid item xs key={ticket.tokenId}>
                    <Card className={classes.root}>
                      ...
                      <CardActions>
                          ...
                          <Box component="div" visibility={ticket.for_offer === true? "visible" : "hidden"}>
                            <Button onClick={() => { forOfferDialogHandleOpen(ticket.tokenId, ticket.order)}} size="small" >Cancel sell</Button>
                          </Box>
                        </CardActions>
                    </Card>
                </Grid>
