...
function TicketCategoryDetail({onReloadList, onSetOverlay, ipfs}) {  
  ...
  return (<div>
    ...
    <CancelForBidCancelDialog onReloadList={onReloadList} onSetOverlay={onSetOverlay}
...
function ForBidDialog({onReloadList, onSetOverlay, forBidDialogOpen, setForBidDialogOpen, tokenForDialog}) {
  ...
  function CancelForBidCancelDialog({onReloadList, onSetOverlay, cancelForBidDialogOpen, setCancelForBidDialogOpen, tokenForDialog}) {
