...
function TicketMarketDetail({onReloadList, onSetOverlay, onSetSnackBarMessage, eventKey}) {  
  ...
  return (<div>
    ...
    <SellDialog onReloadList={onReloadList} onSetOverlay={onSetOverlay} onSetSnackBarMessage={onSetSnackBarMessage}
...
function SellDialog({onReloadList, onSetOverlay, onSetSnackBarMessage,
