...
import { GetSellOrdersByItem, GetMyTicketsPerEvent, ApolloClientCustom, CreateMakerOrder } from ".././UtilsData";
...
const { createTypeData } = require("../EIP712");
...
function TicketCategoryDetail({onReloadList, onSetOverlay, ipfs}) {  
  ...
  const sellDialogHandleSell  = async() => {
    ...
    const form = CreateMakerOrder(address, EnvConstant.contractAddress, tokenForDialog, "1000000000000000");
