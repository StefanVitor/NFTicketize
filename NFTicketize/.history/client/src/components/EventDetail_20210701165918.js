...
function TicketCategoryDetail({onReloadList, onSetOverlay, ipfs}) {  
  ...
  const sellDialogHandleSell  = async() => {
    ...
    const orderDataJSON = await axios.post("https://api-staging.rarible.com/protocol/v0.1/ethereum/order/encoder/order", form);
    ...
    const sendSellOrder = await axios.post("https://api-staging.rarible.com/protocol/v0.1/ethereum/order/orders", form);
