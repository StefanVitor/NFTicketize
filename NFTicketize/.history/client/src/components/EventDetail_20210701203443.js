      ...
      <Box pt={1}>
        <FormControl component="fieldset">
          ...
          <RadioGroup aria-label="Tickets types" row  name="ti" value={ticketsTypes} onChange={ event => handleChangeTicketsTypes(event.target.value)}>
            ...
            <FormControlLabel value={TicketsTypesEnum.FOR_OFFER_SELL} control={<Radio />} label="Offer - sell" />
            <FormControlLabel value={TicketsTypesEnum.FOR_OFFER_BUY} control={<Radio />} label="Offer - buy" />
          </RadioGroup>
        </FormControl>
      </Box>
    </Box>
