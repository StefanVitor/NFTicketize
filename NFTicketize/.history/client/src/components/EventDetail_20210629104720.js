...
function TicketCategoryDetail({onReloadList, onSetOverlay}) {  
  ...
  const [ticketCategoryForDialog, setTicketCategoryForDialog] = React.useState(-1);
  ...
  const buyDialogHandleOpen = (tierKey, tierName) =>  {
    ...
    setTicketCategoryForDialog(tierKey);
