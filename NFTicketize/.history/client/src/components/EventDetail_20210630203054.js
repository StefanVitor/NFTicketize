...
function TicketCategoryDetail({onReloadList, onSetOverlay}) {  
  ...
  const getTickets = async () => {
    ...
    const itemMetaById =  await axios.get(`https://api-dev.rarible.com/protocol/v0.1/ethereum/nft/items/` +  EnvConstant.contractAddress + `:2/meta`);
  ...
  const buyDialogHandleBuy = async() => {
    ...
    try {
      ...
      var config = {
        ...
        headers: { 
          'pinata_api_key': "29181844ea2013b98d2c",// KEY_HERE, 
          'pinata_secret_api_key': "403d71b84c4b73d4d6b08cfe55c0a8d3ee515eac79e33d4f93811ea82aca30c0", // SECRET_KEY_HERE, 
          'Content-Type': 'application/json'
        },
        data: data
      };
      /*
      const url1 = `https://api.pinata.cloud/data/testAuthentication`;
        axios
            .get(url1, {
                headers: {
