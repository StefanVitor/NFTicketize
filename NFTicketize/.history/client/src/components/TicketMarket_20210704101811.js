...
function TicketCategoryDetail({onReloadList, onSetOverlay, onSetSnackBarMessage, ipfs}) {  
...
function TicketMarketInner({ipfs}) {
  ...
  return (
    ...
    >
      <div>
        <TicketCategoryDetail onReloadList={reloadListFunc} onSetOverlay={setOverlayFunc} onSetSnackBarMessage = {setSnackBarMessage} ipfs = {ipfs}>
