...
contract("NFTicketize", accounts => {
  ...
  it("...should mint correct value", async () => {
    ...
    await NFTicketizeInstance.mintAndTransfer([0, "-", creators([account_two]), 0, ["-"]], account_two)

    await NFTicketizeInstance.fillInformationsAboutTicket(eventId, 0, [0], {from : accounts[1]});
