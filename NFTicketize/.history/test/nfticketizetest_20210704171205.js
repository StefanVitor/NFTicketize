...
contract("NFTicketize", accounts => {
  ...
  it("...should mint correct value", async () => {
    ...
    var eventId = 0;
    await NFTicketizeInstance.customMint(account_two, eventId, 0, [0, 1], ['-', '-'], {from : accounts[0]});
    // Get stored value
    //const storedData = await simpleStorageInstance.get.call();
  ...
  it("...should check royalty correct set", async () => {
    ...
    await NFTicketizeInstance.customMint(eventId, ticketCategory, [2, 3]);
  ...
  it("should send coin correctly", async () => {
    ...
    var ticketCategory = 1;
    await NFTicketizeInstance.customMint(eventId, ticketCategory, [4, 5], overrides);
