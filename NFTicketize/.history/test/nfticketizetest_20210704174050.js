...
contract("NFTicketize", accounts => {
  ...
  it("should send coin correctly", async () => {
    ...
    console.log("Account_one-before-after" + account_one_ending_balance - account_one_starting_balance);
    console.log("Account_two-before-after" + account_two_ending_balance - account_two_starting_balance);
