...
contract NFTicketize{ 
  ...
  function createTicketCategory(uint256 _eventId, uint32 _maxTickets, uint256 _ticketPrice, uint256 _resellTicketType, uint32 _resellTicketValue, string memory _metadataIpfsCid) public {
