...
contract NFTicketize is ERC721 , RoyaltiesV2Impl  {
    ...
    event NewTicket(uint256 eventId, uint256 ticketCategoryId, uint256 id, uint32 forOfferSell);
...
/*
    ...
    function customMint(
        ...
        for (uint counter = 0; counter < _tokenIdsForMint.length; counter++) {
            ...
            //Set tocken uri
            _setTokenURI(_tokenIdsForMint[counter], _tokenURI[counter]);

            Ticket memory _ticket;
            _ticket.eventId = _eventId;
            _ticket.ticketCategoryId = _ticketCategoryId;
            _ticket.forOfferSell = 0;
            ...
            emit UpdateTicketCategory(_eventId, _ticketCategoryId, ticketCategories[_ticketCategoryId].currentMintTickets, _ticketCategory.maxTickets,
                _ticketCategory.ticketPrice, _ticketCategory.resellTicketValue, _ticketCategory.metadataIpfsCid);
        }
    }
